...
const FilteringItem = () => {
  ...
  const [getAdvanced, setAdvanced] = useState([
    ...
    { id: uuidv4(), name: "Lavarropas" },
    { id: uuidv4(), name: "Garage" },
    { id: uuidv4(), name: "Piscina" },
    { id: uuidv4(), name: "Televisión por cable" },
    { id: uuidv4(), name: "Heladera" },
    { id: uuidv4(), name: "WiFi" },
    { id: uuidv4(), name: "Energía solar" },
    { id: uuidv4(), name: "Agua potable" },
    { id: uuidv4(), name: "Drenajes" },
        ...
        <div className="search_option_two">
          <div className="candidate_revew_select">
            ...
            >
              ...
              <option value="bungalow">Finca</option>
              <option value="condo">Apartamento</option>
              <option value="house">Condominio</option>
        ...
        <div className="search_option_two">
          <div className="candidate_revew_select">
            ...
            >
              ...
              <option value="apartment">Lote</option>
              <option value="bungalow">Finca</option>
              <option value="condo">Apartamento</option>
